...
While the application is open, the shortcut CTRL+SHIFT+E can be used to paste character-by-character. This is useful for password textboxes that disallow pasting. Note that since this option is agnostic to UI context, unexpected events can occur from using this shortcut outside of text fields.
