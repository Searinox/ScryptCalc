...
Password, salt, and output size of max 192 characters are supported. The output can be formatted as one of the following: bin, hex, base32, base64, and base85. Since the output format isn't in bytes it will of course change the number of characters in the final output.
